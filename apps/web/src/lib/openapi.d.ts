...
export interface paths {
    ...
    "/api/v1/habits/{habit_id}/entries": {
        ...
        put?: never;
        /** Create Entry */
        post: operations["create_entry_api_v1_habits__habit_id__entries_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/habit-entries/{entry_id}": {
        ...
        post?: never;
        /** Delete Entry */
        delete: operations["delete_entry_api_v1_habit_entries__entry_id__delete"];
        options?: never;
        head?: never;
        /** Update Entry */
        patch: operations["update_entry_api_v1_habit_entries__entry_id__patch"];
        trace?: never;
    };
}
...
export interface components {
    schemas: {
        ...
        DashboardResponse: {
            ...
            /** Habits */
            habits: components["schemas"]["DashboardHabitResponse"][];
            /** Timeline */
         ...
         * @enum {string}
         */
        HabitKind: "local" | "google_hydration" | "google_weight";
        /** HabitUpdate */
        HabitUpdate: {
            /** Title */
            title?: string | null;
...
export interface operations {
    ...
    create_entry_api_v1_habits__habit_id__entries_post: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    delete_entry_api_v1_habit_entries__entry_id__delete: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    update_entry_api_v1_habit_entries__entry_id__patch: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
