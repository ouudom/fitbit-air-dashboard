...
final class AuthenticationTest extends TestCase
{
    ...
    {
        config()->set('lifestats.google.client_id', 'client-id');
        config()->set('lifestats.google.redirect_uri', 'http://localhost/api/auth/callback');
        config()->set('lifestats.google.scopes', 'scope-one scope-two');
    ...
    {
        config()->set('lifestats.google.client_id', 'client-id');
        config()->set('lifestats.google.client_secret', 'client-secret');
        config()->set('lifestats.google.redirect_uri', 'http://localhost/api/auth/callback');
